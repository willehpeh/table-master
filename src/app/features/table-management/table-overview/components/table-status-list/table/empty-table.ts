		...
		<div class="col-span-full text-center py-16" data-testid="no-tables-message">
			<div class="w-16 h-16 mx-auto mb-4 rounded-full bg-gray-700/50 flex items-center justify-center">
				<svg class="w-8 h-8 text-gray-400"  stroke="currentColor" viewBox="0 0 24 24">
					<path stroke-linecap="round" fill="none" stroke-linejoin="round" stroke-width="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 100 4m0-4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 100 4m0-4v2m0-6V4"/>
				</svg>
			</div>
